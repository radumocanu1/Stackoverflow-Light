...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema stackoverflow_light
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema stackoverflow_light
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `stackoverflow_light` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `stackoverflow_light` ;

-- -----------------------------------------------------
-- Table `stackoverflow_light`.`Users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`Users` (
...
-- -----------------------------------------------------
-- Table `stackoverflow_light`.`Questions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`Questions` (
                                                                 `Id` CHAR(36) CHARACTER SET 'ascii' NOT NULL,
    ...
    FOREIGN KEY (`UserId`)
    REFERENCES `stackoverflow_light`.`Users` (`Id`)
    ON DELETE CASCADE)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `stackoverflow_light`.`Answers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`Answers` (
                                                               `Id` CHAR(36) CHARACTER SET 'ascii' NOT NULL,
    `Content` LONGTEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NOT NULL,
    `Score` INT NOT NULL,
    ...
    REFERENCES `stackoverflow_light`.`Questions` (`Id`)
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `stackoverflow_light`.`OidcUserMappings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`OidcUserMappings` (
                                                                        `UserId` CHAR(36) CHARACTER SET 'ascii' NOT NULL,
...
-- -----------------------------------------------------
-- Table `stackoverflow_light`.`UserQuestionViews`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`UserQuestionViews` (
                                                                         `UserId` CHAR(36) CHARACTER SET 'ascii' NOT NULL,
    `QuestionId` CHAR(36) CHARACTER SET 'ascii' NOT NULL,
...
-- -----------------------------------------------------
-- Table `stackoverflow_light`.`__EFMigrationsHistory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `stackoverflow_light`.`__EFMigrationsHistory` (
...
INSERT INTO `stackoverflow_light`.`Users` (`Id`, `Username`) VALUES
...
INSERT INTO `stackoverflow_light`.`Questions` (`Id`, `Content`, `UserId`, `Score`, `ViewsCount`) VALUES
...
INSERT INTO `stackoverflow_light`.`Answers` (`Id`, `Content`, `Score`, `UserId`, `QuestionId`) VALUES
...
INSERT INTO `stackoverflow_light`.`UserQuestionViews` (`UserId`, `QuestionId`) VALUES
